...
import { Tabs, Alert, Button, Image } from 'antd';
            ...
            <div className='style_appWrapper__3uO7t ffa-grs-qualification-list' style={{ display: "flex", background: "rgb(246, 246, 250)", paddingTop: "58px" }}>
                <div className='_597hhBvevm4x676WEayFAA==  fxg-app-header' id='fxg-pc-header' style={{ zIndex: 1100 }}>
                    <div className='hNyK1iw9cM5hkl1qVJ2SKg=='>
                        <div className="M0OVYqC6U2xIFRF5Urk83g=="><h1 className="+0MG4BXqpRBgUm92lkXt5Q==" id="fxg-pc-header-name">抖店</h1></div>
                        ...
                        <div className='_4Lh3m+eQeHwUoBdSWbd6Bg=='>
                            <div className="index_menuItem__23aIf"><div className="index_menuTitle__3BMCM">电商罗盘</div></div>
                            ...
                            <div className="index_menuItem__23aIf"><div className="index_menuTitle__3BMCM">精选联盟</div></div>
                                ...
                                <div className='_1G-iuKVWxLHY6c4iaSKjKP'>
                                    <div className='spiderman-tab-wrapper' style={{ fontSize: "16px" }}>
                                        <Tabs defaultActiveKey="0" tabBarExtraContent={
                                            <a style={{ fontSize: "14px", color: "rgb(25, 102, 255)", marginBottom: 0 }}><BookOutlined style={{ color: "rgb(25, 102, 255)" }} />入驻标准及资质要求</a>
                                        }>
                                            <TabPane tab={
                                                <span>
                                                    主体资质
                                            ...
                                            <div className='_3zLQYmWAiQsjxmpRHxhokl'>
                                                ...
                                                <div className='ant-row _3aJWiCG93IlaU_3qf7a1Uc' style={{ margin: "-8px -8px 8px" }}>
                                                    ...
                                                    <div className="ant-col _2oUK91ircK4AKJrKQ8fyHD" style={{ padding: "8px", flex: "1 1 auto" }}>
                                                        <Image
                                                            width={88}
                                                            src="https://fxg.jinritemai.com/pssresource/external/download?ticket=rkKg2i4xYRAJxR2%2BJ9raedzbz9baUuXzbh%2BMnqzj1Amo1QIbi5aUay2wU78e1Q94O3DMRQohsDDG8SrXgMcPL8wfqhEcx1DdeGILM3DxJZkwh16usvdQInuKrUpGXHwzi%2Ffp1nsxRfTI8ZUGTtwS0MDWWhst3HucepidjpP9DrkjI78GupsiNvXjH8LgPBtHzeeL86rOklVs5HpvQfN83CDc0eO55AeWbO7w8188l5vHzhPQ%2F%2Bj%2BXvagt1DZBDTwheAPzt%2FXnPoLgy6inq3czF7c0qH0H0Yu25ET8lHBtgR4%2FoPrQN6M6gZ29am9ueUXr4d6EWNatsGHlMNdMhSHfDdsRL%2F1RcscXrwvFQ%3D%3D"
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div className='ant-row _3aJWiCG93IlaU_3qf7a1Uc' style={{ margin: "-8px -8px 8px" }}>
                                                    ...
                                                    <div className="ant-col _2oUK91ircK4AKJrKQ8fyHD" style={{ padding: "8px", flex: "1 1 auto" }}>
                                                        <Image
                                                            width={88}
                                                            src="https://fxg.jinritemai.com/pssresource/external/download?ticket=YS8SkokRUlQmDqVETTN8WgbDwNnVsJ0yL%2F36PhZLRQcwx7DegxSqsmN2oy17ARFJaBt1jGFrD%2BZltBgyYjAiQw%2FER0GGX%2FBRI8Dp59merAPJBzxs5momMRL5b2bjerZwy2ZuDoHzK74YDt%2BoXOXjBVSNFfDCV46KJ6wgM9JaIR6O6ga%2FPQCScVaxfN4ZdSqritHk%2BI38brFIvcM0QQ5eCJJWEgwOfosz6w9yI%2BDSidfTBfEviPzUnq4hCD2o6zHKZWrTuLDRcd8qDHr3hn3gXhbwLbMvfifzWN0uEQsYRbidNX7bT%2FBKkJGFeUGzezeVnhBK4dDBYDjaqDoxaOcDDeqZsbN%2Bs69MfEiV0Q%3D%3D"
                                                        />
                                                    </div>
                                                </div>
